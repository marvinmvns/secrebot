#!/usr/bin/env python3
"""
Script para remover métodos que foram movidos para handlers específicos
"""
import re

# Métodos que foram movidos para handlers específicos
methods_to_remove = [
    # VideoSummaryHandler
    'handleVideoSubmenu',
    'handleResumirVideoCommand', 
    'handleResumirVideo2Command',
    'processVideoSummaryResilient',
    
    # AudioTranscriptionHandler  
    'handleTranscreverCommand',
    'handleTranscreverResumir',
    'handleAudioMessage',
    'handleWhisperSilentConfigCommand',
    'handleWhisperSilentSearchCommand',
    'handleWhisperSilentCommand',
    'processWhisperSilentConfigMessage',
    'processWhisperSilentSearchMessage',
    
    # ScheduleHandler
    'handleAgendaSubmenu',
    'handleAgendabotCommand',
    'handleListarCommand', 
    'handleDeletarCommand',
    'handleImportarAgendaCommand',
    'processSchedulerMessage',
    'processDeletarMessage',
    'createSchedule'
]
...
print(f"Removidos {len(removed_methods)} métodos movidos para handlers:")
